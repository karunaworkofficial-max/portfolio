                  ...
                  {Object.entries(profile.socialLinks).map(([platform, url]) => {
                    ...
                    return (
                      <a 
                        ...
                        className="w-10 h-10 rounded-full bg-surface/50 border border-text/10 flex justify-center items-center text-text/70 hover:text-bg hover:bg-primary hover:border-primary transition-all shadow-sm"
                        aria-label={platform}
                        title={platform}
                      >
                        {getIcon(platform)}
